...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    * Table structure*/
    ...
    public StudentModel getSingleStudentDetails(long id) {
        ...
        StudentModel studentModel = new StudentModel(cursor.getInt(cursor.getColumnIndex(STUDENT_ID)), cursor.getString(cursor.getColumnIndex(STUDENT_NAME)), cursor.getString(cursor.getColumnIndex(STUDENT_COLLEGE)), cursor.getString(cursor.getColumnIndex(STUDENT_ADDRESS)), cursor.getLong(cursor.getColumnIndex(STUDENT_PHONE_NUMBER)));
